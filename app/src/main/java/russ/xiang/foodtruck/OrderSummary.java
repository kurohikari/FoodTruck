...
public class OrderSummary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView)findViewById(R.id.orderlist); // (ListView) findViewById(R.id.lvItems);
        ...
        if (finalorder.size()>0) {
            ...
            listView.setAdapter(itemsAdapter);// connect adappter to a ListView to be populated
        }
        else
        {
